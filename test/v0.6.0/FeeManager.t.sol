...
import {FeeLib} from "@src/v0.6.0/libraries/FeeLib.sol";
...
contract TestFeeManager is BaseTest {
    ...
    function test_updateRates_revertIfManagementRateAboveMaxRates() public {
        uint16 MAX_MANAGEMENT_RATE = FeeLib.MAX_MANAGEMENT_RATE;
        uint16 MAX_PERFORMANCE_RATE = FeeLib.MAX_PERFORMANCE_RATE;
